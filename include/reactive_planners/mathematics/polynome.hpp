...
public:
  ...
  inline int degree() { return ORDER; };
 ...
 * @tparam ORDER
 */
template <int ORDER> class TimePolynome : public Polynome<ORDER> {
public:
  /*! Constructor */
  TimePolynome() {
    final_time_ = 0.0;
  ...
  double get_init_pose() const { return init_pose_; }
  double get_init_speed() const { return init_speed_; }
  double get_init_acc() const { return init_acc_; }
  double get_final_pose() const { return final_pose_; }
  double get_final_speed() const { return final_speed_; }
  double get_final_acc() const { return final_acc_; }
   ...
   * @param final_acc 
   */
  void set_parameters(double final_time, double init_pos, double init_speed,
                      double init_acc, double final_pos, double final_speed,
                      double final_acc);
