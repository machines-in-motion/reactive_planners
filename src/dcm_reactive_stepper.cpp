                                    ...
                                    const Eigen::Ref<const Eigen::Vector3d>& v_des)
{
    ...
    if(new_) {
        ...
        new_end_eff_trajectory_3d_.init_calculate_dcm(v_des, com_height, t_min, t_max);
    }
    else{
    ...
    const bool &is_closed_loop)
{
    ...
    if(new_ && nb_usage_of_force_ % 10 != 0){//Lhum TODO update 10 automatically
        ...
        if (is_left_leg_in_contact_)  // check which foot is in contact
        {
            ...
            new_end_eff_trajectory_3d_.update_robot_status(right_foot_position_,
        ...
        else
        {
            ...
            new_end_eff_trajectory_3d_.update_robot_status(left_foot_position_,
                                                    left_foot_velocity_,
    ...
    if (is_left_leg_in_contact_)  // check which foot is in contact
    {
        ...
        if(new_) {
            succeed =
                    succeed && new_end_eff_trajectory_3d_.compute(previous_support_foot_position_,
                                                                  right_foot_position_,
                                                                  right_foot_velocity_,
                                                                  ...
                                                                  end_time,
                                                                  is_left_leg_in_contact_);
            nb_force_ = new_end_eff_trajectory_3d_.get_forces(forces_,
                                                              right_foot_position_,
                                                              right_foot_velocity_,
                                                              right_foot_acceleration_);
            Eigen::Vector3d slack = new_end_eff_trajectory_3d_.get_slack_variables();

        }
        else {
            succeed =
                    succeed && end_eff_trajectory_3d_.compute(previous_support_foot_position_,
                                                       right_foot_position_,
                                                       right_foot_velocity_,
                                                       right_foot_acceleration_,
                                                       next_support_foot_position_,
                                                       ...
                                                       current_time,
                                                       end_time);
            end_eff_trajectory_3d_.get_next_state(current_time + control_period_,
                                           right_foot_position_,
                                           right_foot_velocity_,
                                           right_foot_acceleration_);
        }
