...
class DcmReactiveStepper(object):
    def __init__(self, is_left_leg_in_contact, l_min, l_max, w_min, w_max,
        ...
        self.right_foot_position = np.array([0, 0, 0])
    ...
    def run(self, time, current_flying_foot_position, com_position, com_velocity, base_yaw):
        ...
        start_time = 0.0
        current_time = self.dcm_vrp_planner.get_duration_before_step_landing()
        end_time = (self.stepper_head.get_time_from_last_step_touchdown() +
