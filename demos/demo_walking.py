...
if __name__ == "__main__":
    ...
    dcm_reactive_stepper = DcmReactiveStepper(is_left_leg_in_contact=True, l_min=-0.5, l_max=0.5, w_min=-0.5, w_max=0.5,
                                              t_min=0.1, t_max=0.2, l_p=0.1235 * 2, com_height=0.26487417,
    ...
    for i in range(1000):
        ...
        if dcm_reactive_stepper.time_from_last_step_touchdown == 0:
            t = 0
        x_com, xd_com, _ = sim.step(dcm_reactive_stepper.time_from_last_step_touchdown - t,
    ...
    plt.plot(plt_time, plt_is_left_leg_in_contact, label="is_left_leg_in_contact")
